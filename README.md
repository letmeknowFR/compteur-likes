...
<ol><li>Téléchargez la dernière version de l'<a href="https://www.arduino.cc/en/Main/Software">IDE Arduino.</a></li>
	...
	<li>Déplacer les librairies téléchargées avec le compteur de likes dans votre répertoire Arduino <strong><em>/librairies</em></strong></li><img src="/Media/Diagram.png" alt="" class="wp-image-1869"><br><figcaption>Votre répertoire Arduino devrait ressembler à cela</figcaption>
...
<ol><li>Pour lier votre compte Facebook, vous devez vous rendre sur l'<a href="https://developers.facebook.com/?locale=fr_FR">API Facebook</a> et vous identifier. (Afin de pouvoir afficher le nombre de likes sur votre page vous devez en être administrateur).</li>
	...
	<li>Ajoutez le token d’accès et votre ID de page dans le fichier like_counter.ino à la ligne <strong>25-26</strong>.</li><br><img align="center" src="/Media/Capture7.PNG" alt="" class="wp-image-1885"/>
</ol>
...
<ol><li>Afin de lier votre compte Instagram, commencez par vous identifier sur la plateforme dédiée <a href="https://www.instagram.com/developer/">ici</a>.</li>
	...
	<li>Dans l'onglet "Security", décochez "Disable implicit OAuth". Puis cliquez sur "Register".</li><img src="/Media/Capture11.PNG" alt="" class="wp-image-1890"><br><br>
	<li>Une fois enregistré, vous devriez pouvoir voir votre application comme ceci, et trouver votre Client ID.</li><img src="/Media/Capture12.PNG" alt="" class="wp-image-1891"><br><br>
	...
	<li>Il ne vous restera plus qu’à l’ajouter dans le code, ligne <strong>29</strong>.</li><img src="/Media/Capture13.PNG" alt="" class="wp-image-1892"><br><br>
</ol>
...
<ol><li>Pour&nbsp;lier votre compte Twitter, rien de plus simple. Récupérez votre nom de page dans l’url. (ex: <a href="https://twitter.com/letmeknowfr?lang=fr">https://twitter.com/letmeknowfr?lang=fr</a>&nbsp;→ le nom de notre Twitter est "letmeknowfr")</li>
	<li>Puis ajoutez le dans le programme du compteur ligne <strong>27</strong>.</li><img src="/Media/Capture9.PNG" alt="" class="wp-image-1902"><br><br>
</ol>

### Téléverser le code
***
<ol><li>Afin de téléverser le code sur votre carte, commencez par sélectionner votre carte. Dans “Outils”&nbsp;→ “Type de carte”, sélectionner “WeMos D1 (Retired)” si vous utilisez le LinkNode D1. Puis paramétrer le de la manière suivante :</li><img src="/Media/Capture17.png" alt="" class="wp-image-1904"><br><br>
	<li>Sélectionnez le port COM sur lequel votre carte est connectée.</li>
	<li>Et enfin, cliquez sur <strong>Téléverser</strong>.</li><img src="/Media/Capture16.PNG" alt="" class="wp-image-1905"><br><br>
</ol>